...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card card-color-1 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Régions</h5>
                    <p class="card-text fs-2">{{ $nbRegions }}</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-color-2 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Villes</h5>
                    <p class="card-text fs-2">{{ $nbVilles }}</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-color-3 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Provinces</h5>
                    <p class="card-text fs-2">{{ $nbProvinces }}</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-color-4 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Établissements</h5>
                    <p class="card-text fs-2">{{ $nbEtablissements }}</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-color-5 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Fournisseurs</h5>
                    <p class="card-text fs-2">{{ $nbFournisseurs }}</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-color-6 mb-3">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card card-color-7 mb-3">
                <div class="card-body">
                    <h5 class="card-title">Produits</h5>
                    <p class="card-text fs-2">{{ $nbProduits }}</p>
                </div>
