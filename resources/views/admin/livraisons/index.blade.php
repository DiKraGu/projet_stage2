    ...
    <tbody>
        @forelse($livraisons as $livraison)
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($livraison->menu->semaine)->format('d/m/Y') }}</td>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.livraisons.destroy', $livraison) }}" method="POST" class="d-inline" onsubmit="return confirm('Confirmer l\'annulation ?')">
                        @csrf
                        @method('DELETE')
        ...
        @empty
            <tr><td colspan="6" class="text-center">Aucune livraison planifiée</td></tr>
        @endforelse
    </tbody>
</table>
